...
namespace SoftEngine
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void Page_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            _mesh.Faces[1] = new Face { A = 0, B = 1, C = 4 };
            _mesh.Faces[2] = new Face { A = 0, B = 2, C = 7 };
            _mesh.Faces[3] = new Face { A = 0, B = 4, C = 7 };
            _mesh.Faces[4] = new Face { A = 1, B = 2, C = 3 };
            _mesh.Faces[5] = new Face { A = 1, B = 3, C = 6 };
            _mesh.Faces[6] = new Face { A = 1, B = 5, C = 6 };
            _mesh.Faces[7] = new Face { A = 1, B = 4, C = 5 };
            _mesh.Faces[8] = new Face { A = 2, B = 3, C = 7 };
            _mesh.Faces[9] = new Face { A = 3, B = 6, C = 7 };
